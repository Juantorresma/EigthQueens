...
2. Can you explain why the sentinel class in the Ob jective-C and Smalltalk
versions of the eight-queens puzzle do not need to provide an implementation for the method ndSolution, despite the fact that this message is
